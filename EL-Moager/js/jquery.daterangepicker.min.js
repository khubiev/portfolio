...
!function (e) {
    ...
    e.dateRangePickerLanguages = {
        ...
        function u() {
            ...
            e && (e = parseInt(e));
            var t = se.find(".month1").width(), a = se.find(".gap").width() + (e ? 2 * e : 0), n = se.find(".month2").width();
        ...
        function D(t) {
            ...
            if (r) {
                ...
                d += t.width() / 2;
                var u = se.find(".date-range-length-tip"), m = u.css({
                    visibility: "hidden",
                    display: "none"
                }).html(r).width(), h = u.height();
        ...
        function ae(t) {
            var a = t.toLowerCase(), n = t in oe ? oe[t] : a in oe ? oe[a] : null, r = e.dateRangePickerLanguages["default"];
